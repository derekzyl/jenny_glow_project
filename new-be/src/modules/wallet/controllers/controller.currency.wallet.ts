...
/* 
  CURRENCIES
*/
export const addCurrency = catchAsync(async (req: Request, res: Response) => {
  const { user } = req;
...
export const getAllCurrencies = catchAsync(async (req: Request, res: Response) => {
...
export const updateCurrency = catchAsync(async (req: Request, res: Response) => {
  if (typeof req.params['currencyId'] === 'string') {
    const { user } = req;

    const currency = await walletCurrencyService.updateCurrencyById(new mongoose.Types.ObjectId(req.params['currencyId']), {
...
export const deleteCurrency = catchAsync(async (req: Request, res: Response) => {
  if (typeof req.params['currencyId'] === 'string') {
...
export const deactivateCurrency = catchAsync(async (req: Request, res: Response) => {
  if (typeof req.params['currencyId'] === 'string') {
    const { user } = req;
...
export const getAllTradableAssets = catchAsync(async (_req: Request, res: Response) => {
...
export const addCryptoAssets = catchAsync(async (req: Request, res: Response) => {
...
export const getAllTradableAssetsWithIcons = catchAsync(async (_req: Request, res: Response) => {
  const tradableAssets = await walletCurrencyService.tradableAssetsPlusIcons();
  res.status(httpStatus.OK).json(tradableAssets);
});

export const updateDbTradeableAssets = catchAsync(async (_req: Request, res: Response) => {
...
export const getAllTradableAssetsTypes = catchAsync(async (_req: Request, res: Response) => {
...
export const getAssetByType = catchAsync(async (req: Request, res: Response) => {
...
export const queryUserCurrencies = catchAsync(async (req: Request, res: Response) => {
