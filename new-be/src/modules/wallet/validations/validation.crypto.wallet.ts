...
import Joi from 'joi';
import { NewCryptoTransactionPayload, NewRegisteredHDWallet } from '../interfaces/interfaces.crypto.wallet';

const withdrawRequestBody: Record<keyof NewCryptoTransactionPayload, any> = {
  toAddress: Joi.string().required(),
  amount: Joi.string().required(),
  currencyCode: Joi.string(),
};
const createDepositAddressRequestBody: Record<keyof NewRegisteredHDWallet, any> = {
