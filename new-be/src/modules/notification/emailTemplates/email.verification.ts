export const emailVerificationTemplate = ({ date, name, token }: { token: string; name: string; date: string }): string => {
  return `
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa"
                              ...
                              <tr>
                                <td align="left" style="padding:20px;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                    Welcome to PayPaddy! We're thrilled to have you here..<br><br>Please copy the following token and paste it in the token field:</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0"><span class="msohide es-button-border"
                                    style="border-style:solid;border-color:#2CB543; letter-spacing:8px;background:#f38220;border-width:0px;display:block;border-radius:30px;width:auto;padding-bottom:12px;padding-top:12px;mso-hide:all"><div
                                       class="es-button msohide" target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:48px;padding:15px 20px 15px 20px;display:block;background:#f38220;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #7630f3;mso-hide:all;padding-left:5px;padding-right:5px">${token}</div> </span> <!--<![endif]--></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                                    ...
                                    <tr>
                                      <td align="left" style="padding:0;Margin:0">
                                        <p
                                          ...
                                          This link expire in 24 hours. If you have questions, <a target="_blank"
                                            ...
                                            href="mailto:contacts@paypaddy.com">we're here to help</a> </p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
...
export const sendResetPinEmailTemplate = ({ date, name, token }: { token: string; name: string; date: string }): string => {
  return `
                              ...
                              <tr class="es-visible-simple-html-only">
                                <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank"
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:14px"><img
                                      ...
                                      alt="Logo"
                                      style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;width:150px;height:150px"
                                      height="60" title="paypaddy" width="38"></a> </td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa"
                              ...
                              <tr>
                                <td align="left" style="padding:20px;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                    Please copy the following token and paste it in the token field:</p>
                                </td>
                              </tr>
                            </table>
                          </td>
...
export const sendResetPasswordTemplate = ({ date, name, token }: { token: string; name: string; date: string }): string => {
  return `
