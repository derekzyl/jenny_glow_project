import { Currencies, FLWResponse } from './interface.flutterwave';
import { ChargeCardType, ChargeNGBankType } from './interface.charge.flutterwave';
...
export type TransactionEventType = {
  ...
  object:
    ...
    | 'CARD_CHARGE'
    | 'TRANSACTION';
  action: 'loaded' | 'switched' | 'click' | 'request' | 'typing' | 'charge' | 'submitted' | 'validate' | 'completion';
  context: 'web' | string;
