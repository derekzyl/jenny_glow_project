import { CardProviders, ChargeMeta, CountryCodes, Currencies, FLWResponse, PaymentTypes } from './interface.flutterwave';
...
export interface ValidateChargeResponse extends ChargeCardResponse, UssdChargeResponse, BankTransferResponse {}
