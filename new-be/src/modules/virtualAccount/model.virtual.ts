...
import { IVirtualAccountDoc, IVirtualAccountModel } from './interface.virtual';
...
const VirtualAccountSchema = new Schema<IVirtualAccountDoc, IVirtualAccountModel>(
  {
    userId: {
...
VirtualAccountSchema.static(
  'isExists',
  async function (userId: Types.ObjectId, orderRef: string, excludeVirtualWalletId: Types.ObjectId): Promise<boolean> {
...
const VIRTUAL_ACCOUNTS = model<IVirtualAccountDoc, IVirtualAccountModel>('VIRTUAL_ACCOUNTS', VirtualAccountSchema);
