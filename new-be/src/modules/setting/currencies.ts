...
// export const cryptoCurrencyCodes = ['BTC', 'ETH', 'LTC', 'XRP', 'USDT', 'DOGE', 'SHIB'];

export type CryptoCurrencyCodesT = (typeof cryptoCurrencyCodes)[number];

// export const

// Combine both enums into a single enum
export const allCurrencyCodes: string[] = [...Object.values(FiatCurrencyCodes), ...Object.values(cryptoCurrencyCodes)];
...
export const cryptoChains: string[] = Object.keys(defaultCrytoNodes);

export enum NetworkBitpwrE {
  TESTNET = 'TESTNET',
  MAINNET = 'MAINNET',
}

export enum ModeBitpwrE {
  LIVE = 'LIVE',
  TEST = 'TEST',
}
