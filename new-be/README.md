# PayPaddy Backend [RESTful API]

[![Node.js CI](https://github.com/derekzyl/be_paypaddy/actions/workflows/node.js.yml/badge.svg)](https://github.com/derekzyl/be_paypaddy/actions/workflows/node.js.yml)

The backend has features such as authentication using JWT, request validation, unit and integration tests, continuous integration, docker support, API documentation, pagination, etc.
...
```bash
git clone https://github.com/derekzyl/be_paypaddy.git
cd be_paypaddy
```
...
- [PayPaddy Backend \[RESTful API\]](#paypaddy-backend-restful-api)
...
yarn compile && yarn pre:dev # (recommended)
```
...
// allow on USERs to be able to perfom KYCs
// if (req.user.role != 'user') {
//   throw new ApiError(httpStatus.FORBIDDEN, 'User not allowed');
// }
```
