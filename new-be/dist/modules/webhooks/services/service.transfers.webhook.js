...
import { CurrencyCodesEnum } from '../../flutterwave/interfaces/interface.flutterwave';
import { CrudService } from '../../genCrud';
import { logger } from '../../logger';
import { notificationService } from '../../notification';
import { paymentProviders } from '../../setting/currencies';
import { allPermissions } from '../../setting/roles';
import { VIRTUAL_SUB_ACCOUNTS } from '../../subVirtualAccount';
import TRANSFERS from '../../tranfers/model.transfers';
import { getTransferByIdFromFlw, updateTransferServiceWithRef } from '../../tranfers/service.transfers';
import { FIAT_TRANSACTIONS } from '../../transactions';
import { verifyTransactionAPI } from '../../transactions/api/api.fiat.transactions';
 ...
 */
export const transferWebHook = async (data) => {
    ...
    await CrudService.update({ Model: FIAT_TRANSACTIONS, exempt: '-_v' }, {
        amount: trn.amount,
 ...
 * the function.
 */
export const depositWebHook = async (data) => {
    logger.info(`data: ${JSON.stringify(data)}`);
...
//# sourceMappingURL=service.transfers.webhook.js.map