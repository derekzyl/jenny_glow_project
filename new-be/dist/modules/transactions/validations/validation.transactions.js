...
const queryTransactionsSchema = {
    query: Joi.object().keys(Object.assign({ referenceId: Joi.string().optional(), status: Joi.string().valid('PENDING', 'SUCCESS', 'FAILED', 'CANCELLED', 'REJECTED').optional(), trxType: Joi.string()
            .valid(...Object.values(TrxTypes))
            .optional(), userId: Joi.string().custom(objectId).optional(), id: Joi.string().custom(objectId).optional() }, joiQuery)),
};
// Schema for getting user transactions
const getUserTransactionsSchema = {
    query: Joi.object().keys(Object.assign({}, joiQuery)),
};
...
export { createTransactionSchema, getTransactionByIdSchema, getUserTransactionByIdSchema, getUserTransactionsSchema, queryTransactionsSchema, updateTransactionSchema };
//# sourceMappingURL=validation.transactions.js.map