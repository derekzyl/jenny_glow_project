...
export const addToCartItem = catchAsync(async (req, res) => {
    const cartItem = {
        productId: new Types.ObjectId(req.body.productId),
...
export const removeFromCartItem = catchAsync(async (req, res) => {
    const cartItem = {
        productId: new Types.ObjectId(req.body.productId),
        cartId: new Types.ObjectId(req.body.cartId),
        variantId: req.body.variantId ? new Types.ObjectId(req.body.variantId) : undefined,
...
export const getCartItemById = catchAsync(async (req, res) => {
    const cartItemId = new Types.ObjectId(req.params['id']);
    const cartItem = await cartService.getCartItemById(cartItemId);
    res.json(cartItem);
});
export const getCartItemsByCartId = catchAsync(async (req, res) => {
...
export const updateCartItemsByAddressChange = catchAsync(async (req, res) => {
    const cartId = new Types.ObjectId(req.params['id']);
