...
export const addressQuerySchema = Joi.object(Object.assign({ userId: Joi.custom(objectId).optional(), country: Joi.string().optional(), state: Joi.string().optional(), localGovernment: Joi.string().optional(), name: Joi.string().optional(), isDefault: Joi.boolean().optional() }, joiQuery));
//# sourceMappingURL=validation.address.js.map