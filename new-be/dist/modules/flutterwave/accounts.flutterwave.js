...
class VirtualAccount {
    ...
    async checkBvn(data) {
        const { data: response } = await this.base.request(`v3/kyc/bvns${data.bvn}`, {
            method: 'GET',
        });
        return response;
    }
    ...
    async createBulk(data) {
        const { data: response } = await this.base.request(`v3/bulk-virtual-account-numbers`, Object.assign(Object.assign({}, data), { method: 'POST' }));
        return response;
    }
    /**
     ...
     */
    async create(data) {
        const { data: response } = await this.base.request(`v3/virtual-account-numbers`, Object.assign(Object.assign({}, data), { is_permanent: true, method: 'POST' }));
        return response;
    }
    /**
     ...
     */
    async fetch(data) {
        const modData = Object.assign({}, data);
        const { data: response } = await this.base.request(`v3/bulk-virtual-account-numbers/${data.order_ref}`, modData, 'GET');
        return response;
    }
    /**
     ...
     */
    async fetchBulk(data) {
        const modData = {
            method: 'GET',
            excludeQuery: true,
        };
        const { data: response } = await this.base.request(`v3/bulk-virtual-account-numbers/${data.batch_id}`, modData);
        return response;
    }
    /**
    ...
    async updateBvn(data) {
        ...
        // api.flutterwave.com/v3/virtual-account-numbers/:order_ref
        const modData = Object.assign({}, data);
        const { data: response } = await this.base.request(`v3/virtual-account-numbers/${modData.order_ref}`, modData, 'PUT');
        return response;
    }
    /**
    ...
    async deleteAccount(data) {
        const modData = Object.assign({}, data);
        const { data: response } = await this.base.request(`v3/virtual-account-numbers/${modData.order_ref}`, modData, 'DELETE');
        return response;
    }
}
...
//# sourceMappingURL=accounts.flutterwave.js.map