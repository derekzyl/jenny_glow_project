...
export const productQuerySchema = Joi.object(Object.assign({ category: Joi.custom(objectId).optional(), subCategory: Joi.custom(objectId).optional(), featured: Joi.boolean().optional() }, joiQuery));
...
//# sourceMappingURL=validation.product.js.map