...
// Message Routes
// Create Message
router.post('/:chatId/messages', auth( /* permission to send message */), validate(chatValidations.createMessage), chatController.createMessage);
// Get Message By Id
router.get('/messages/:id', auth( /* permission to access message */), validate(chatValidations.getMessageById), chatController.getMessageById);
router.get('/users-messages/all', auth( /* permission to access message */), chatController.getAllMessagesByUser);
// Delete Message By Id
router.delete('/messages/:id', auth( /* permission to delete message */), validate(chatValidations.deleteMessageById), chatController.deleteMessageById);
// Get All Messages
