export const emailVerificationTemplate = ({ date, name, token }) => {
    return `
...
export const sendResetPinEmailTemplate = ({ date, name, token }) => {
    return `
...
export const sendResetPasswordTemplate = ({ date, name, token }) => {
    return `
