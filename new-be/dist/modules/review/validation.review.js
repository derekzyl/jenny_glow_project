...
export const updateUserReview = {
    body: Joi.object().keys(Object.assign({}, updateReviewSchema)),
    params: Joi.object().keys({
        id: Joi.string().required().custom(objectId),
    }),
};
...
export const getApprovedProductReviews = {
    ...
    query: Joi.object().keys(Object.assign(Object.assign({}, getManyReviewSchema), { isApproved: Joi.boolean().valid(true).required() })),
};
export const getPendingReviewByUser = {
    query: Joi.object().keys(Object.assign(Object.assign({}, getManyReviewSchema), { isReviewed: Joi.boolean().valid(false).required() })),
};
//# sourceMappingURL=validation.review.js.map