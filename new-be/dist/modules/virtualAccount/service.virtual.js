 ...
 */
export const createVirtualAccount = async (request) => {
...
const sanitizeVirtualAccount = (virtualAccount) => {
    // Remove sensitive data from virtualAccount object
    const sanitizedVirtualAccount = Object.assign({}, virtualAccount);
 ...
 */
export const getVirtualAccountByWalletId = async (walletId) => {
