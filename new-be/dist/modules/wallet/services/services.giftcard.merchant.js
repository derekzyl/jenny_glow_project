 ...
 */
export const addNewGiftCardMerchant = async (giftCardMerchantBody) => {
 ...
 */
export const queryGiftCardMerchants = async (filter, options) => {
 ...
 */
export const getGiftCardMerchantById = async (id) => {
 ...
 * @returns {Promise<GiftCardMerchantDocI | null>}
 */
export const getGiftCardMerchantByMerchant = async (merchant) => {
 ...
 * @returns {Promise<GiftCardMerchantDocI | null>}
 */
export const updateGiftCardMerchantById = async (giftCardMerchantId, updateBody) => {
 ...
 * @returns {Promise<GiftCardMerchantDocI | null>}
 */
export const deleteGiftCardMerchantById = async (giftCardMerchantId) => {
    const card = await getGiftCardMerchantById(giftCardMerchantId);
    if (!card) {
        throw new ApiError(httpStatus.NOT_FOUND, 'Card not found');
    }
 ...
 * @returns {Promise<GiftCardMerchantDocI | null>}
 */
export const deactivateGiftCardMerchantById = async (giftCardMerchantId, userId) => {
    const updateBody = { active: false, updatedByUserId: userId };
    const card = await updateGiftCardMerchantById(giftCardMerchantId, updateBody);
    return card;
};
//# sourceMappingURL=services.giftcard.merchant.js.map