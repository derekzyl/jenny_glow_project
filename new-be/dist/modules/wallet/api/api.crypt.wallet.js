 ...
 */
export async function createUserSubAccount(payload) {
    try {
        const response = await bpwr.SubAccountBitpwr.createSubAccountBitpwr(Object.assign(Object.assign({}, payload), { autoGenerateAddress: false }));
        return response;
    }
    catch (error) {
 ...
 */
export async function createCryptoWalletAddress(payload) {
    try {
        const response = await bpwr.SubAccountBitpwr.createSubAccountAddressBitpwr(Object.assign({}, payload));
        return response;
    }
    catch (error) {
 ...
 */
export async function getSubAccountBalance({ accountId, subAccountId }) {
    try {
 ...
 */
export async function getWalletAddressAccountBalance(addressId) {
    try {
 ...
 */
export async function getBitpwrAssetsAddressBySubAccountIdsAssets(subAccountId) {
    try {
 ...
 * specified assetId.
 */
export async function getBitpwrAssetsAddressByAssetId(assetId) {
    try {
 ...
 */
export async function getBitpwrAddressById(addressId) {
    try {
 ...
 */
export async function getAccountBitpwrAdminAccounts({ page = 1 }) {
    try {
 ...
 */
export async function getBitpwrAdminAccountBalance(accountId) {
    try {
 ...
 * account ID.
 */
export async function getBitpwrAdminSubAccounts(accountId) {
    try {
 ...
 */
export async function getBitpwrAdminAccountAssets(accountId) {
    try {
 ...
 * @return the data fetched from the Bitpwr API for the specified account ID.
 */
export async function getBitpwrAdminAccountsById(accountId) {
    try {
 ...
 */
export async function getBitpwrAssetsAddressByAccountId(accountId) {
    try {
 ...
 */
export async function createBitpwrAssetsByAdmin({ accountId, label, asset, }) {
    try {
 ...
 */
export async function getBitpwrAdminAssetsByAccountId(accountId) {
    try {
...
//# sourceMappingURL=api.crypt.wallet.js.map